<?php
   ...
   # ========================================================================#
        ...
        class resize
        {
            ...
            function __construct($imageSOURCE,$fileName = '') {
				$this->image = $imageSOURCE;
				if(empty($imageSOURCE)){ $this->image = $this->openImage($fileName);}
			...
			private function getOptimalCrop($newWidth, $newHeight) {
                ...
                if ($heightRatio < $widthRatio) { $optimalRatio = $heightRatio; } else { $optimalRatio = $widthRatio; }
			...
			public function saveandOUTPUT($savePath, $imageQuality="100") {
                $extension = strrchr($savePath, '.');
			    $extension = strtolower($extension);
                switch($extension) {
                    case '.jpg':
